...
function updateHtml(data) {
  let aqiPm25 = calcAQIpm25(entry.pm25);
  let aqiPm10 = calcAQIpm10(entry.pm10);

  //update HTML
  document.getElementById("time").innerHTML = entry.time;
  document.getElementById("aqiPm25").innerHTML = aqiPm25;
  document.getElementById("aqiPm10").innerHTML = aqiPm10;
  document.getElementById("pm25").innerHTML = "(PM2.5: " + entry.pm25 + " µg/m³)";
  document.getElementById("pm10").innerHTML = "(PM10: " + entry.pm10 + " µg/m³)";
